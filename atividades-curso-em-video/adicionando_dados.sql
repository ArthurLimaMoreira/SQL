...
(default, 'Arthur', '2000-08-18', 'M', '105.3', '1.92', default),
(default, 'Júlia', '2002-07-22', 'F', '87.2', '1.71', 'Argentina');

/*  SEGUNDA FORMA DE INSERÇÃO, CASO SEJA NA MESMA ORDEM DECLARADA NA TABELA*/
insert into pessoas values
(default, 'Marcos', '1998-03-27', 'M', '94.3', '1.64', 'Brasil'),
(default, 'Jean', '2003-02-15', 'M', '87.657', '1.83', 'França');
